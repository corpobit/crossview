...
func (r *UserRepository) FindOrCreateSSOUser(username, email, firstName, lastName, extractedRole string, roleAttributePathProvided bool) (*User, error) {
	if username == "" && email == "" {
