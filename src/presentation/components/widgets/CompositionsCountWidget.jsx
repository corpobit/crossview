...
export const CompositionsCountWidget = () => {
  ...
  return (
    <Container p={6}>
      <Text fontSize="sm" color="gray.600" _dark={{ color: 'gray.400' }} mb={3}>Compositions</Text>
      <Text fontSize="3xl" fontWeight="bold" color="gray.900" _dark={{ color: 'gray.100' }} mb={1}>{count || 0}</Text>
      <Text fontSize="xs" color="gray.500" _dark={{ color: 'gray.500' }}>Total compositions</Text>
    </Container>
  );
};
